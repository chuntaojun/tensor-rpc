package com.tensor.rpc.core.cache;
 ...
 * @since
 */
public class NativeMethodManager {

    private static final ConcurrentHashMap<String, NativeMethodManager.RegisterInfo> METHOD_EXECUTOR = new ConcurrentHashMap<>();
    ...
    public static boolean isNative(RpcMethodRequest request) {
        ...
        return RpcInfoManager.containRegisterInfo(key);
    }
